                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-muted mb-0">Crea un nuevo Grupo Sanguineo con la pantalla intutiva de SoftwareClinic.</p>
                                <div class="card-body">
                                <form method="POST" action="{{ route('grupo_sangre.store') }}">
                                 @csrf
                                 <div class="mb-3">
                                     <label for="Nbre" class="form-label">Grupo Sanguineo</label>
