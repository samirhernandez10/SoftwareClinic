...
@section('title') SoftwareClinic @endsection
    @section('content')
        ...
        <a href="{{ route('poblacion.create') }}" class="btn btn-primary">Añadir Nuevo</a>
...
@endif
        ...
        <div class="card-body">
            <div class="col-sm-12">
                ...
                <td>
                    <form action="{{ route('poblacion.destroy', ['poblacion' => $estado->id]) }}" method="POST" style="display:inline;">
                                 @csrf
                                 @method('DELETE')
