...
@section('title') SoftwareClinic @endsection
    @section('content')
        ...
        <a href="{{ route('tipoconceptoagrup.create') }}" class="btn btn-primary">Añadir Nuevo</a>
    ...
    <div class="alert alert-success border-0">
        ...
        <div class="card-body">
            <div class="col-sm-12">
                ...
                <tbody>
                @foreach($tipoconceptoagrup as $estado)
                <tr>
                <td>{{ $estado->id }}</td>
                <td>{{ $estado->Nbre }}</td>
                ...
                <td>
                    <form action="{{ route('tipoconceptoagrup.destroy', ['tipoconceptoagrup' => $estado->id]) }}" method="POST" style="display:inline;">
                                 @csrf
                                 @method('DELETE')
