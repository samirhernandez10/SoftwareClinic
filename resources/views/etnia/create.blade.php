                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                <form method="POST" action="{{ route('etnia.store') }}">
                                 @csrf
                                 <div class="mb-3">
                                     <label for="nombre" class="form-label">Etnia</label>
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('Guardar') }}</button>
                                <button onclick="location.href='{{ route('etnia.index') }}'" class="btn btn-danger">Cancelar </button>
                            </div>
                        </div>
                    </form>
                </div>
