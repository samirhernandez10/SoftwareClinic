...
@section('title') SoftwareClinic @endsection
    @section('content')
        ...
        <a href="{{ route('manual.create') }}" class="btn btn-primary">Añadir Nuevo</a>
...
@endif
        ...
        <div class="card-body">
            <div class="col-sm-12">
                ...
                <td>
                    <form action="{{ route('manual.destroy', ['manuales' => $estado->id]) }}" method="POST" style="display:inline;">
                                 @csrf
                                 @method('DELETE')
