...
@section('title') SoftwareClinic @endsection
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('li_3') Etnia @endslot
            @slot('title')Etnia @endslot
        @endcomponent
        @section('css')
        ...
        <a href="{{ route('etnia.create') }}" class="btn btn-primary">Añadir Nuevo</a>
...
@endif
        ...
        <div class="card-body">
            <div class="col-sm-12">
                ...
                <td>
                    <form action="{{ route('etnia.destroy', ['etnia' => $estado->id]) }}" method="POST" style="display:inline;">
                                 @csrf
                                 @method('DELETE')
