    	...
    	<?php } ?>
			...
			<?php else: ?>
	            ...
	            <div class="nicdark_section nicdark_text_align_left nicdark_search_nf_section">
		        	...
		        	<p><?php esc_html_e("NOTHING FOUND : You can search another word or return to","clinical"); ?> <a href="<?php echo esc_url(home_url()); ?>"><?php esc_html_e("homepage !","clinical"); ?></a></p>
		            <div class="nicdark_section nicdark_height_20"></div>
		            <?php get_search_form(); ?>
