                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Nuevo Zona Residencial</h4>
                                <p class="text-muted mb-0">Crea un nuevo Zona Residencial con la pantalla intutiva de SoftwareClinic.</p>
                                <div class="card-body">
                                <form method="POST" action="{{ route('zonaresidencial.store') }}">
                                 @csrf
                                 <div class="mb-3">
                                     <label for="nombre" class="form-label">Zona Residencial</label>
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('Guardar') }}</button>
                                <button onclick="location.href='{{ route('zonaresidencial.index') }}'" class="btn btn-danger">Cancelar </button>
                            </div>
                        </div>
                    </form>
                </div>
