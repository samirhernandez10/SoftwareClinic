                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-muted mb-0">Crea un nuevo Municipio con la pantalla intutiva de SoftwareClinic.</p>
                                <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('Guardar') }}</button>
                                <button onclick="location.href='{{ route('municipio.index') }}'" class="btn btn-danger">Cancelar </button>
                            </div>
                        </div>
                    </form>
                </div>
