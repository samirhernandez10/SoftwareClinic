...
@section('title') SoftwareClinic @endsection
    @section('content')
        ...
        <a href="{{ route('estado_civil.create') }}" class="btn btn-primary">Añadir Nuevo</a>
...
@endif
        ...
        <div class="card-body">
            <div class="col-sm-12">
                ...
                <td>
                    <form action="{{ route('estado_civil.destroy', ['estado_civil' => $estado->id]) }}" method="POST" style="display:inline;">
                                 @csrf
                                 @method('DELETE')
