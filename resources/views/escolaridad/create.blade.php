...
@section('title') SoftwareClinic @endsection
    ...
    @section('content')
        ...
        @slot('li_1') Interfaz de usuario @endslot
            ...
            @slot('li_3') Escolaridad @endslot
            @slot('li_4') Añadir Nuevo @endslot
            @slot('title') Escolaridad @endslot
        @endcomponent
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Nuevo Escolaridad</h4>
                                <p class="text-muted mb-0">Crea un nuevo Escolaridad con la pantalla intutiva de SoftwareClinic.</p>
                                <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('Guardar') }}</button>
                                <button onclick="location.href='{{ route('escolaridad.index') }}'" class="btn btn-danger">Cancelar </button>
                            </div>
                        </div>
                    </form>
                </div>
