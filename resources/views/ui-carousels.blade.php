...
@section('title') Dashboard @endsection
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('li_3') Carrusel @endslot
            @slot('title') Carrusel @endslot
        @endcomponent
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-5 offset-lg-1 align-self-center">
                                    <div class="p-5">
                                        <span class="bg-soft-pink p-2 rounded">Temas Samir</span>
                                        <h1 class="my-4 font-weight-bold">Administre su trabajo con <span class="text-primary">SoftwareClinic</span>.</h1>
                                        <p class="font-14 text-muted">SoftwareClinic Es un  Bootstrap 5 panel de administración,
                                        Es totalmente receptivo e incluye características increíbles.
                                        para ayudar a crear aplicaciones web de forma rápida y sencilla.
                                        </p>
                                    ...
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ URL::asset('assets/images/small/img-2.jpg') }}" class="d-block w-400" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ URL::asset('assets/images/small/img-1.jpg') }}" class="d-block w-400" alt="...">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ URL::asset('assets/images/small/img-3.jpg') }}" class="d-block w-400" alt="...">
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end col-->
