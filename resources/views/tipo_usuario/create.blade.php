        ...
        <div class="row justify-content-center">
            <div class="my-10">
                <div class="shadow p-3 mb-5 bg-body rounded">
                   <br><br><div class="card-header">{{ __('Tipo Usuario') }}</div>
                   <br><br>                  
                            <div class="card-body">
                    <form class="form-container" method="POST" action="{{ route('tipo_usuario.store') }}">
                            @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <button onclick="location.href='{{ route('tipo_usuario.index') }}'" class="btn btn-danger">Cancelar </button>
                            </div>
                        </div>
                    </form>
                </div>
