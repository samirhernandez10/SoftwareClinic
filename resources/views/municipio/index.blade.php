...
@section('title') SoftwareClinic @endsection
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('li_3') Municipio @endslot
            @slot('title')Municipio @endslot
        @endcomponent
        @section('css')
        ...
        <a href="{{ route('municipio.create') }}" class="btn btn-primary">Añadir Nuevo</a>
...
@endif
        ...
        <div class="card-body">
            <div class="col-sm-12">
                ...
                <td>
                    <form action="{{ route('municipio.destroy', ['municipio' => $estado->id]) }}" method="POST" style="display:inline;">
                                 @csrf
                                 @method('DELETE')
