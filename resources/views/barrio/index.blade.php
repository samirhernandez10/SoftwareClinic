...
@section('title') SoftwareClinic @endsection
    @section('content')
        ...
        <a href="{{ route('barrio.create') }}" class="btn btn-primary">Añadir Nuevo</a>
            ...
            <div class="col-sm-12">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                 <thead>
                    ...
                    <th data-priority="3">Manicipio</th>
                ...
                <tbody>
                @foreach($barrio as $estado)
                <tr>
                <td>{{ $estado->id }}</td>
                <td>{{ $estado->nombre }}</td>
                <td>{{ $estado->Municipio->Departamento->nombre }}</td>
                ...
                <td>
                    <form action="{{ route('barrio.destroy', ['barrio' => $estado->id]) }}" method="POST" style="display:inline;">
                                 @csrf
                                 @method('DELETE')
