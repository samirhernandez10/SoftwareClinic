                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-muted mb-0">Crea un nuevo Departamento con la pantalla intutiva de SoftwareClinic.</p>
                                <div class="card-body">
                                <form method="POST" action="{{ route('departamento.store') }}">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                     <label for="codpais" class="form-label">Codigo del Pais</label>
                                     <input id="codpais" type="text" class="form-control @error('codpais') is-invalid @enderror" name="codpais" value="{{ old('codpais') }}" required autocomplete="">
                                    @error('codpais')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <button type="submit" class="btn btn-primary">{{ __('Guardar') }}</button>
                                <button onclick="location.href='{{ route('departamento.index') }}'" class="btn btn-danger">Cancelar </button>
                            </div>
                        </div>
                    </form>
                </div>
